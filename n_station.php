...
$sc=mysqli_real_escape_string($connect, $_POST['sc']);
...
?>
 ...
 <h3 style="color:#F00;"> <?php if(isset($message)) echo $message; ?></h3>
   ...
   <div class="form-group">
    <label class="control-label col-sm-2" for="othername">Litre Price</label>
    <div class="col-sm-10"> 
      <input type="text" class="form-control" name="eid" required  placeholder="Litre Price">
    </div>
          </div>
