...
<li >
  <a href="m_report.php">
      ...
      <li >
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-files-o"></i> <span>Employees</span>
            <span class="pull-right-container">
              <small class="fa fa-angle-left pull-right "></small>
               </span>
          </a>
          ...
          <li ><a href="profile_employes.php"><i class="fa fa-group"></i>Employees List</a></li>            
          </ul>
        </li>
 ...
 <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li ><a href="add_expenses.php"><i class="fa fa-user-plus"></i>Add Expense</a></li>
          <li ><a href="expenses_report.php"><i class="fa fa-group"></i>Expenses Report</a></li>
...
<li>
  ...
  <div class="content-wrapper"> 
   ...
   <h2 align="center" style="color:black;"> Add New  Tanker</h2>
...
$t_number=mysqli_real_escape_string($connect, $_POST['tnumber']);
$d_name=mysqli_real_escape_string($connect, $_POST['dname']);
$status=mysqli_real_escape_string($connect, $_POST['status']);
$e_id=mysqli_real_escape_string($connect, $_POST['eid']);
...
if(mysqli_query($connect, $sql)){
   ...
   $message= "Tanker added Successfully...";
} 
else{
...
?>
 ...
 <h3 style="color:#F00;"> <?php if(isset($message)) echo $message; ?></h3>
    ...
    <label class="control-label col-sm-2" for="surname">Tanker Number</label>
    <div class="col-sm-10"> 
      <input type="text" class="form-control" name="tnumber" required  placeholder="Tanker Number">
            </div>
           </div>
...
<option value="Faulty">Faulty</option>
   ...
   <div class="form-group">
    <label class="control-label col-sm-2" for="othername">Employee ID</label>
    <div class="col-sm-10"> 
      <input type="text" class="form-control" name="eid" required  placeholder="Employee ID">
    </div>
          </div>
