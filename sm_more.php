...
<li>
  ...
  <div class="content-wrapper"> 
   ...
   <h2 align="center" style="color:blue;"> Station Managers Biodata</h2>

   
 
   <?php
$userInfo = mysqli_query($connect,"select * from station_manager where ID='$_GET[ID]'");
...
<input type="text" readonly class="form-control" name="dob" value="<?php  echo  $user_information['local_government']  ?>"/>
</div>
