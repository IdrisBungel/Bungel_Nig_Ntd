...
<div class="wrapper">
  ...
  <div class="content-wrapper"> 
   ...
   <h2 align="center" style="color:blue;"> Add  Maintenance Record</h2>
...
$cn=mysqli_real_escape_string($connect, $_POST['cn']);
...
?>
 ...
 <h3 style="color:#F00;"> <?php if(isset($message)) echo $message; ?></h3>
    ...
    <label class="control-label col-sm-2" for="MMID">Maintenance Manager ID</label>
    <div class="col-sm-10"> 
...
?>
           ...
           <div class="form-group">
    <label class="control-label col-sm-2" for="othername">Problem</label>
    <div class="col-sm-10"> 
      <input type="text" class="form-control" name="problem" required  placeholder="problem">
    </div>
          </div>
