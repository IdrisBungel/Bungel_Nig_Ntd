...
$t_number=mysqli_real_escape_string($connect,$_POST['tanker_number']);
$d_name=mysqli_real_escape_string($connect,$_POST['driver_name']);
$e_id=mysqli_real_escape_string($connect,$_POST['employee_id']);
...
<div class="wrapper">
  <header class="main-header">
    <a href="mm_login_home.php" class="logo">
      <span class="logo-mini"><b>PP</b>MS</span>      
...
<li>
 ...
 <?php
          $userInfo = mysqli_query($connect,"select * from tankers where tanker_number='$_GET[tanker_number]'");
