...
$station_manager=mysqli_real_escape_string($connect,$_POST['station_manager']);
$litre_price=mysqli_real_escape_string($connect,$_POST['litre_price']);
...
<div class="form-group">
<label for=""><b>Liter Price</b></label>
<input type="text" name="litre_price" required class="form-control"value="<?php  echo  $user_information['litre_price']  ?>"/>
</div>

<div class="form-group">
<label for=""><b>Station Category</b></label>
<input type="text" name="station_category" required class="form-control"value="<?php  echo  $user_information['station_category']  ?>"/>
</div>

<div class="form-group">
<label for=""><b>Password</b></label>
<input type="text" name="password" required class="form-control"value="<?php  echo  $user_information['password']  ?>"/>
</div>
