...
$query = "SELECT * FROM maintenance_manager where maintenancemanager_id='$username' AND password='$password'";
              ...
              <div class="container-fluid">
                ...
                <div class="navbar-header">
                  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
                    ...
                    <span class="icon-bar"></span>
                       ...
                       <h3> <span class="letter">BUNGEL NIG LTD</span><span></span></h3>
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li><a href="sm_login.php">STATION MANAGER</a></li>
                  <li><a class="is-active" href="mm_login.php">MAINTENANACE MANAGER</a></li>
</ul>
                </div> 
              </div> 
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h3><strong>MAINTENANCE MANAGER </strong> </h3>
