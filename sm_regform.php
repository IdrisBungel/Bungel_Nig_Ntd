...
$query ="select * from stations";
  $all_stations= mysqli_query($connect,$query);
?>
<!DOCTYPE html>
<html>
<head>
...
<li >
 ...
 <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li ><a href="add_expenses.php"><i class="fa fa-user-plus"></i>Add New</a></li> 
...
$employee_id=mysqli_real_escape_string($connect, $_POST['adm_number']);
