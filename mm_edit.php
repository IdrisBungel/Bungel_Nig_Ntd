...
$sog=mysqli_real_escape_string($connect,$_POST['sog']);
$local=mysqli_real_escape_string($connect,$_POST['local']);
...
<li>
 ...
 <?php
          $userInfo = mysqli_query($connect,"select * from maintenance_manager where ID='$_GET[ID]'");
...
<input type="text" name="employee_id" required class="form-control"value="<?php  echo  $user_information['maintenancemanager_id']  ?>"/>
</div>
...
<input type="text" required class="form-control" name="local" value="<?php  echo  $user_information['local']  ?>"/>
</div>
...
<input type="text" required class="form-control" name="password" value="<?php  echo  $user_information['password']  ?>"/>
</div>
