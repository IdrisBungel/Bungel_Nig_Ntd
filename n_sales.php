...
<div class="wrapper">
  ...
  <div class="content-wrapper"> 
   ...
   <h2 align="center" style="color:blue;"> Add Daily Sales  Record</h2>
...
$l_sold=mysqli_real_escape_string($connect, $_POST['l_sold']);
$a_litre=mysqli_real_escape_string($connect, $_POST['a_litre']);
$l_price=mysqli_real_escape_string($connect, $_POST['l_price']);
...
<option value="others"> others</option>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10"> 
      <input type="text" class="form-control" name="l_sold" required  placeholder="Litres Sold">
    </div>
          </div>
...
<?php
 require "dbcon.php";
$getRecord= mysqli_query($connect,"select * from stations where station_id='$user'");
...
?>
   <div class="form-group">
    ...
    <div class="col-sm-10"> 
      <input type="text" class="form-control" name="l_price" value="<?php echo"$litre_price[litre_price]"; ?>" required readonly>
    </div>
  </div>
